...
// 获取当前用户的祷告（仅获取自己提交的祷告）
const fetchPrayers = async () => {
    try {
      const response = await fetch(`https://withelim.com/api/prayers/mine`, {
  ...
  return (
    <div style={{ fontFamily: "sans-serif", lineHeight: 1.6, minHeight: "100vh", padding: "0" ,width:"100%" }}>
       {/* Header 组件 */}
      ...
      <h2 style={{paddingTop:"150px"}}>
        ...
        {language==="t_cn"?"我的祷告":"My Prayers"}</h2>
      <Masonry
